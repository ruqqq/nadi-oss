...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    // The transcript is the thing people copy out of, so it opts back in to
    // selection where touch devices otherwise switch it off (see index.css).
    data-selectable=""
    className={cn(
      "is-user:dark flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-hidden text-sm",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
      // Assistant content spans the full column so tool cards have a consistent
      // width regardless of whatever else shares the message (user bubbles stay w-fit).
