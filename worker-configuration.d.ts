/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 6fc0ded728fd1b0535d7be42f2c2e5a1)
...
interface __BaseEnv_Env {
  ...
  POSTHOG_HOST: string;
  POSTHOG_CAPTURE_CONTENT: string;
  LOG_LEVEL: string;
  APP_BASE_URL: string;
